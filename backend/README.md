...
## Project Structure
    ...
    ├── testapiautoteammemb_89568  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_89568`
...
2. Clone this repo and `cd testapiautoteammemb_89568`
